  ...
  return (
    ...
    >
      <div className="absolute text-center max-w-2xl px-6 opacity-0 drop-shadow-[0_4px_24px_rgba(0,0,0,1)] -mb-16 md:-mb-24">
        <h2 className="text-4xl md:text-5xl font-light text-white tracking-tight leading-tight [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">
          It starts quietly.
        </h2>
        <p className="mt-4 text-zinc-300 text-lg md:text-xl font-light [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">
      ...
      <div className="absolute text-center max-w-2xl px-6 opacity-0 drop-shadow-[0_4px_24px_rgba(0,0,0,1)]">
        <h2 className="text-4xl md:text-5xl font-medium text-white tracking-tight leading-tight [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">
      ...
      <div className="absolute text-center max-w-2xl px-6 opacity-0 drop-shadow-[0_4px_24px_rgba(0,0,0,1)]">
        <h2 className="text-5xl md:text-7xl font-bold text-white tracking-tighter leading-none [text-shadow:_0_4px_20px_rgb(0_0_0_/_100%)]">
          CONSUMED.
        </h2>
        <p className="mt-6 text-zinc-300 text-xl md:text-2xl font-medium [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">
